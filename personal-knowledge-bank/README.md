...
2. **Bij nieuwe opdrachten**: voeg een klant, training of voorstel toe aan `business/`.
3. **Bij nieuwe inzichten**: voeg ze toe aan `learning/`, `decisions/` of `personal/`.
4. **Bij AI-gebruik**: laat een AI-agent eerst relevante bestanden lezen voordat die een voorstel, training of mail schrijft.
